...
CREATE TABLE `waste_logs` (
  ...
  `date_discarded` timestamp NULL DEFAULT NULL,
  `item_id` int NOT NULL,
  PRIMARY KEY (`waste_id`),
  KEY `fk_waste_logs_inventory_items1_idx` (`item_id`),
  CONSTRAINT `fk_waste_logs_inventory_items1` FOREIGN KEY (`item_id`) REFERENCES `inventory_items` (`item_id`)
